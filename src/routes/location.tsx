            ...
            <div className="mb-8">
              <div className="flex flex-col md:flex-row md:items-end gap-4 mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <a href={getWazeUrl()} target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium rounded-md transition-colors text-sm">Waze</a>
                </div>
              </div>
